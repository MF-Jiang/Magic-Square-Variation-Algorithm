...
//        {
//            printf("Iteration: %d\n", i);
//            printf("temp_solution: \n");
//            for (int j = 0; j < n; j++)
//            {
//                for (int k = 0; k < n; k++)
//                {
//                    temp_solution[j][k] = best_solution[j][k];
//                    printf("%d ", temp_solution[j][k]);
//                }
//                printf("\n");
//            }
//
//            swap_elements(temp_solution, n);
//            printf("new temp_solution: \n");
//            for (int j = 0; j < n; j++)
//            {
//                for (int k = 0; k < n; k++)
//                {
...
//        for (int j = 0; j < n; j++)
//        {
//            output[i][j] = magic_square[i][j];
//        }
//    }
//
//
//    variable_neighborhood_search(magic_square, n, &output);
//
//
//    //print the results of VNS
//    printf("The best magic square is: \n");
//    for (int i = 0; i < n; i++)
//    {
//        for (int j = 0; j < n; j++)
//        {
...
//        printf("\n");
//    }
//    printf("The cost of the best magic square is: %d\n", objective_function(output, n));
//
//    return 0;
//}
#include <stdio.h>
